...
export interface DirectorySelectListRef {
    refresh: () => void;
}

const DirectorySelectList = forwardRef<DirectorySelectListRef, DirectorySelectListProps>(
    ({ value: paths, onChange }, ref) => {
        // Internal list with error flag
        const [entries, setEntries] = useState<Entry[]>([]);
        const [selected, setSelected] = useState<string[]>([]);

        // Core path check logic
